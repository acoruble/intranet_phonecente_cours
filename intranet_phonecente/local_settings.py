"""
Django settings for intranet_phonecente project.
...
SECRET_KEY = '@ph9p$t&u@+gbb9)1tcxh6lw_x-uiy5t#@2%*q1f9=ms(ds7^@'
...
ROOT_URLCONF = 'intranet_phonecente.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [
            os.path.join(BASE_DIR, 'intranet_phonecente', 'templates'),
...
WSGI_APPLICATION = 'intranet_phonecente.wsgi.application'
